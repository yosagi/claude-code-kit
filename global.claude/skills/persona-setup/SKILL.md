---
name: persona-setup
description: 人格セットアップ。初回起動時に自動呼び出し、または手動で人格変更したいときに使用する。
user_invocable: true
---
...
1. **reports/personas/config.md**: 対話スタイル定義（下記テンプレート参照）
2. **reports/personas/diary.md**: 人格日記（存在しなければテンプレートから作成）
...
現在のモデルに応じて以下の人格で対話すること。モデル情報はシステムプロンプトで確認できる。
...
**[条件]の書き方**: 通常は「Opus のとき」「Sonnet のとき」などモデル条件。1人格のみの場合は条件なしで直接書く。
